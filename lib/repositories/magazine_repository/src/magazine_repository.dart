...
class MagazineRepository {
  ...
  Future<ApiResult<List>> getBannerMagazine() async {
    try {
      var response =
          await _dioClient.get('/api/v1/magazine/list/is-main/banner/');
  ...
  Future<ApiResult<List>> getCatalogMagazine() async {
    try {
      var response = await _dioClient.get('/api/v1/magazine/list/catalog/');
  ...
  Future<ApiResult<Catalog>> getCatalogMagazineDetail(int id) async {
    try {
      var response = await _dioClient.get('/api/v1/magazine/list/catalog/$id');

      return ApiResult.success(data: Catalog.fromJson(response));
    } catch (e) {
      return ApiResult.failure(error: NetworkExceptions.getDioException(e));
    }
  }
  ...
  Future<ApiResult<Map>> getIsScrapped(int id) async {
    try {
      var response = await _dioClient
          .getWithAuth('/api/v1/magazine/detail/$id/update-scrap/');
