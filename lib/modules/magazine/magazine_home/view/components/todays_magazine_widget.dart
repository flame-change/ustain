                      ...
                      children: [
                        ...
                        Container(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(state.magazines![index].title!, style: TextStyle(fontSize: 15.sp),),
                            Text("${state.magazines![index].title!} 설명", style: TextStyle(fontSize: 12.sp)),
                          ],
                        ))
                      ],
                    ),
